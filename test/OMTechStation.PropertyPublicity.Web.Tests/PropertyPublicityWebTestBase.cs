...
{
    public abstract class PropertyPublicityWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PropertyPublicityWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PropertyPublicityWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PropertyPublicityDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PropertyPublicityDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PropertyPublicityDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PropertyPublicityDbContext, Task<T>> func)
        {
            T result;
