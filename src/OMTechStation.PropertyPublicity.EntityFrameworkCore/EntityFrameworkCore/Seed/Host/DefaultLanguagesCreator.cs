...
namespace OMTechStation.PropertyPublicity.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = PropertyPublicityConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(PropertyPublicityDbContext context)
        {
            _context = context;
        }
