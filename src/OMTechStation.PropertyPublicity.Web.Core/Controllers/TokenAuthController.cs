...
using Abp.UI;
using OMTechStation.PropertyPublicity.Authentication.External;
using OMTechStation.PropertyPublicity.Authentication.JwtBearer;
...
namespace OMTechStation.PropertyPublicity.Controllers
{
    ...
    public class TokenAuthController : PropertyPublicityControllerBase
    {
